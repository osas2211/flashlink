...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const formattedLabel = labelFormatter?.(label, payload) ?? itemConfig?.label ?? item.name ?? label
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-2xl border border-border/50 bg-background-secondary px-2.5 py-1.5 text-xs shadow-xl",
          className,
        )}
      >
